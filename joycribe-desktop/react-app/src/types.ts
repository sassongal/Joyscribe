...
// --- Electron API Bridge ---
// This makes TypeScript aware of the `window.api` object defined in `preload.ts`.
declare global {
  interface Window {
    api: {
      getApiKey: () => Promise<string | null>;
      setApiKey: (key: string) => Promise<void>;
      getHardwareAccelSetting: () => Promise<boolean>;
      setHardwareAccelSetting: (isEnabled: boolean) => Promise<void>;
      ...
      saveHistoryEntry: (entry: HistoryEntry) => Promise<HistoryEntry[]>;
      updateHistoryEntry: (entry: Partial<HistoryEntry> & { id: number }) => Promise<HistoryEntry[]>;
