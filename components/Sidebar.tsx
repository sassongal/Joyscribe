    ...
    <div className="mt-auto p-3 bg-[var(--color-background-input)]/50 rounded-lg border border-[var(--color-border)]">
        <div className="flex items-center gap-3">
            ...
            <div className="flex-grow">
                <p className="font-semibold text-[var(--color-text-primary)] text-sm">Demo User</p>
                <p className="text-xs text-[var(--color-text-secondary)]">demo@joycribe.ai</p>
            </div>
            <button className="text-[var(--color-text-secondary)] hover:text-white transition-colors" aria-label="Log out">
    ...
    return (
        <aside className="w-64 bg-[var(--color-background-card)] p-4 flex-shrink-0 flex flex-col border-r border-[var(--color-border)]">
            <div className="flex flex-col items-center text-center gap-2 py-4">
                <img src={logoBase64} alt="Joycribe Logo" className="h-16 w-16" />
                <div>
                    <h1 className="text-2xl font-bold text-[var(--color-text-primary)]">Joycribe</h1>
